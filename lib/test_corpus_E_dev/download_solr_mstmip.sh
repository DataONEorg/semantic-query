...
# mstmip are here: https://search-sandbox-2.test.dataone.org

urlhead='https://cn-sandbox-2.test.dataone.org/cn/v1/query/solr/?fl=title,abstract,attribute&q=identifier:';
dq='"';
